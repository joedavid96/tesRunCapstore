...
<body>
    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="index.html"><img src="../resources/img/core-img/logo.png" alt=""></a>
                <!-- Navbar Toggler -->
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="favourite-area">
                    <a href="#"><img src="../resources/img/core-img/heart.svg" alt=""></a>
                </div>
                <!-- User Login Info -->
                <div class="user-login-info">
                    <a href="#"><img src="../resources/img/core-img/user.svg" alt=""></a>
                </div>
                <!-- Cart Area -->
                <div class="cart-area">
                    <a href="#" id="essenceCartBtn"><img src="../resources/img/core-img/bag.svg" alt=""> <span>3</span></a>
                </div>
            </div>
    ...
    <div class="right-side-cart-area">
        ...
        <div class="cart-button">
            <a href="#" id="rightSideCart"><img src="../resources/img/core-img/bag.svg" alt=""> <span>3</span></a>
        </div>
        ...
        <div class="cart-content d-flex">
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="../resources/img/product-img/product-2.jpg" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                          <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
    ...
    <!-- ##### Welcome Area Start ##### -->
    <section class="welcome_area bg-img background-overlay" style="background-image: url(../resources/img/bg-img/bg-1.jpg);">
                ...
                <div class="col-12 col-md-6">
                    <div class="single_widget_area d-flex mb-30">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="#"><img src="../resources/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Footer Menu -->
